...
func TestParseBencode(t *testing.T) {
	tests := []struct {
		...
		// Basic types
		{"Simple string", "4:spam", []byte("spam"), true},
		...
		// Lists
		{"Simple list", "l4:spam4:eggse", []any{[]byte("spam"), []byte("eggs")}, true},
		{"Empty list", "le", []any{}, true},
		{"Nested list", "ll4:spame4:eggse", []any{[]any{[]byte("spam")}, []byte("eggs")}, true},

		// Dictionaries
		{"Simple dict", "d3:cow3:moo4:spam4:eggse", map[string]any{"cow": []byte("moo"), "spam": []byte("eggs")}, true},
		{"Empty dict", "de", map[string]any{}, true},
		{"Nested dict", "d4:spaml1:a1:bee", map[string]any{"spam": []any{[]byte("a"), []byte("b")}}, true},
		{"Dict with int and list", "d3:bar4:spam3:fooi42ee", map[string]any{"bar": []byte("spam"), "foo": int64(42)}, true},

		// Edge and limit cases
		{"String with colon inside", "13:spam:eggs:ham", []byte("spam:eggs:ham"), true},
		...
		{"Empty key in dict", "d0:3:mooe", map[string]any{"": []byte("moo")}, true},
		...
		// Mixed list
		{"List with mixed types", "li42e4:spamdee", []any{int64(42), []byte("spam"), map[string]any{}}, true},
